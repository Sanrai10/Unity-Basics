...
IL_0046:
	{
		// if (Input.GetKey("s"))
		bool L_13;
		L_13 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteralDAF2BD03270A51BF9C135F3694DCAD2D3E66F465, NULL);
		if (!L_13)
		{
			goto IL_0080;
		}
...
IL_0080:
	{
		// if (Input.GetKey("d"))
		bool L_24;
		L_24 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteralA02431CF7C501A5B368C91E41283419D8FA9FB03, NULL);
		if (!L_24)
		{
			goto IL_00ba;
		}
	}
	{
		...
		*((float*)L_26) = (float)((float)il2cpp_codegen_add(L_27, ((float)il2cpp_codegen_multiply(L_28, L_29))));
		// pos.y -= speed * Time.deltaTime;
		float* L_30 = (&(&V_0)->___y_1);
		float* L_31 = L_30;
		float L_32 = *((float*)L_31);
		float L_33 = __this->___speed_5;
		float L_34;
...
IL_00ba:
	{
		// if (Input.GetKey("a"))
		bool L_35;
		L_35 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteral0A04B971B03DA607CE6C455184037B660CA89F78, NULL);
		if (!L_35)
		{
			goto IL_00f4;
		}
