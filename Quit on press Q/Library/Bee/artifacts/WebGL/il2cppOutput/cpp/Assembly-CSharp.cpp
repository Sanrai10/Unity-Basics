...
IL_0052:
	...
	}
	{
		...
		*((float*)L_16) = (float)((float)il2cpp_codegen_add(L_17, ((float)il2cpp_codegen_multiply(L_18, L_19))));
		...
		float L_25 = __this->___rotateSpeed_6;
...
IL_00b0:
	{
		// if (Input.GetKey("a"))
		bool L_27;
		L_27 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteral0A04B971B03DA607CE6C455184037B660CA89F78, NULL);
		if (!L_27)
		{
			goto IL_010e;
		}
	}
	{
		...
		*((float*)L_29) = (float)((float)il2cpp_codegen_subtract(L_30, ((float)il2cpp_codegen_multiply(L_31, L_32))));
		...
		float L_38 = __this->___rotateSpeed_6;
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_39;
		L_39 = Quaternion_Lerp_m259606226726C2F46E079A5A688B9E24FF7E9A0D(L_35, L_36, ((float)il2cpp_codegen_multiply(L_37, L_38)), NULL);
